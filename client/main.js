...
const createPattern = (e) => {
    e.preventDefault() 
    axios.post(`${baseURL}/makePattern`, {name: nameInput.value, price: priceInput.value, imageURL: imageInput.value, patternURL: patternInput.value})
    .then((response) => {
        imageInput.value = "",
        nameInput.value = "",
        priceInput.value = "",
...
const deletePattern = id => {
    axios.delete(`${baseURL}/deletePattern/${id}`)
    .then((response) => {
       getPatterns()
        console.log(response.data)
    })
...
const updatePattern = () => {
    axios.put(`${baseURL}/updatePattern/${id}`)
    .then((response) => {
       getPatterns() 
       console.log(response.data)
    })
...
modalBtn.addEventListener("click", updatePattern)